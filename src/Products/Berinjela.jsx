    ...
    <>
      ...
      <div className='container grid lg:grid-cols-2 lg:grid-rows-3 grid-cols-1 grid-rows-1 w-full h-full justify-items-center items-center px-4 py-16'>
        <div className='image row-span-3'>
            <img className="mx-auto aspect-h-1 aspect-w-1 w-1/2 overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7" src="/e-comerce_site/images/berinjela.HEIC" alt="Molho de Pimenta" />
        </div>
        <div className='description row-span-2 '>
            <h1 className="text-3xl mt-5 lg:mt-0">Berinjela</h1>
            <h2 className="text-2xl pt-2">R$15</h2>
            <h2 className='text-2xl pt-2'>240ml</h2>
            <p className="text-base pt-3">Ingredientes da Berinjela:</p>
